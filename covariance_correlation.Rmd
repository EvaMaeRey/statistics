...
equation <- c("",
  ...
  "## $$y_i-\\mu_y$$",
  "## $$(x_i-\\mu_x)(y_i-\\mu_y)$$",
  "## $$\\frac{(x_i-\\mu_x)(y_i-\\mu_y)}{n}$$"
  )
```


`r chunk_reveal("cov_steps", display_type = c("md","output"), md = equation)`
...
`r chunk_reveal("cov_steps2", display_type = c("code", "func", "output"), width_left = "27%", width_middle = "37%", width_right = "32%")`
