...
cov_to_cor_equation <- c("## $$\\frac{\\sum_{i=1}^n (x_i-\\mu_x)(y_i-\\mu_y)}{n}$$",
                 ...
                 "## $$\\frac{\\sum_{i=1}^n (x_i-\\mu_x)(y_i-\\mu_y)}{n*\\sigma_y}$$",
                 "## $$\\frac{\\sum_{i=1}^n (x_i-\\mu_x)(y_i-\\mu_y)}{n*\\sigma_y}$$")

```


`r chunk_reveal("cov_steps", display_type = c("md","output"), md = cov_equation)`
...
`r chunk_reveal("lm_steps", display_type = "output", widths = c(49,50), md = cov_to_cor_equation)`
