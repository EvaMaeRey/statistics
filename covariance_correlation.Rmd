...
set.seed(199402)
create_x_y(relationship = 0) %>% data_create_scatterplot() %>% 
  plot_draw_mean_x() %>% 
  plot_draw_mean_y() %>% 
...
`r flipbookr::chunk_reveal("variance_steps", display_type = "output")`
...
set.seed(1934)
create_x_y(relationship = .1) -> data; data %>%  data_create_scatterplot() %>% 
  plot_draw_mean_x() %>% 
  plot_draw_mean_y() %>% 
  plot_draw_differences_x() %>% 
  plot_draw_differences_y() %>% 
...
set.seed(1934)
create_x_y(relationship = -.05) -> data; data %>%  data_create_scatterplot() %>% 
  plot_draw_mean_x() %>% 
  plot_draw_mean_y() %>% 
  plot_draw_differences_x() %>% 
  plot_draw_differences_y() %>% 
