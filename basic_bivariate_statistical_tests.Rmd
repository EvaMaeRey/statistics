...
```{r, echo = F}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/3/35/Chi-square_pdf.svg")
```
...
# OLS model presentation

---

`r chunk_reveal("lm_present")`


```{r lm_present, include = F}
library(gtsummary)
gm_2007_sample_50 %>% 
  lm(formula = lifeExp ~ gdppercap_log10, 
     data = .)
